function introSliderBgInit() {
    const introSection = document.querySelector("[data-js='introSectionBg']");
    const introSlider = document.querySelector("[data-js='introSliderBg']");
